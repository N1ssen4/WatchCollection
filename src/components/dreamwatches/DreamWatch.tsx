...
export const DreamWatch = () => {
  ...
  return (
    <>
        <div className='relative flex items-center md:mx-10 '>
            <MdChevronLeft className='opacity-50 cursor-pointer hover:opacity-100' onClick={slideLeft} size={20}/>
            <div id='slider' className='w-full h-full overflow-x-scroll scroll whitespace-nowrap scroll-smooth scrollbar-hide'>
                    {WatchData.map((watch) =>(
                        <div key={watch.id} className='w-[220px] lg:w-[350px] inline-block p-6 cursor-pointer hover:scale-105 ease-in-out duration-300'>
                        <img  src={watch.img.src}/>
                        <div className='font-serif text-center my-2 md:text-xl lg:text-2xl '>
